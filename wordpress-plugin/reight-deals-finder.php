...
function rgb_register_deal_finder_shortcode($atts) {
    ...
    <div id="rgb-deal-finder-root" class="rgb-deal-finder-wrapper">
      <style>
        ...
        .rgb-pill.new.active { background: #10b981; border-color: #10b981; color: #000; font-weight: 800; }
