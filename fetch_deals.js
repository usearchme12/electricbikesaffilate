  ...
  return [
    {
      ...
      dealScore: 55.0,
      motor_power: '250W MAHLE X20 Drive System (Ultra Lightweight 11.8kg)',
      battery: '250Wh Integrated Lithium-Ion (140km Range)',
      ...
      url: ribbleBaseTracking + encodeURIComponent('https://www.ribblecycles.co.uk/allroad-sl-r-e/'),
      badge_text: 'SAVE £1000 (22% OFF)',
      first_seen: new Date().toISOString().slice(0, 10),
      is_new: true
    },
    {
      id: 'ribble_cycles_hybrid_al_e_trail',
      title: 'Ribble Hybrid AL e Trail Multi-Terrain Electric Bike',
      brand: 'Ribble Cycles',
      retailer: 'Ribble Cycles UK',
      country: 'UK',
      currency: 'GBP',
      ...
      dealBucket: '🔥 Mega Deal',
      dealScore: 35.0,
      motor_power: '250W MAHLE X35+ 40Nm High Torque',
      battery: '250Wh Integrated Lithium-Ion',
      range_miles: '40 - 60 Miles',
      max_speed: '15.5 mph',
      is_uk_legal: true,
      rrp: 2799,
      sale_price: 2199,
      ...
      url: ribbleBaseTracking + encodeURIComponent('https://www.ribblecycles.co.uk/hybrid-al-e-trail/'),
      badge_text: 'SAVE £600 (21% OFF)',
      first_seen: new Date().toISOString().slice(0, 10),
      is_new: true
    },
    {
      id: 'ribble_cycles_cgr_e_al',
      title: 'Ribble CGR E AL All-Road / Commute Electric Bike',
      brand: 'Ribble Cycles',
      retailer: 'Ribble Cycles UK',
      country: 'UK',
      currency: 'GBP',
      ...
      dealBucket: '🔥 Mega Deal',
      dealScore: 32.5,
      motor_power: '250W MAHLE X30 Drive System',
      battery: '250Wh Integrated Lithium-Ion',
      range_miles: '45 - 65 Miles',
      max_speed: '15.5 mph',
      is_uk_legal: true,
      rrp: 2899,
      sale_price: 2399,
      ...
      url: ribbleBaseTracking + encodeURIComponent('https://www.ribblecycles.co.uk/cgr-e-al/'),
      badge_text: 'SAVE £500 (17% OFF)',
      first_seen: new Date().toISOString().slice(0, 10),
      is_new: true
    },
    {
      id: 'ribble_cycles_allgrit_e_al',
      title: 'Ribble ALLGRIT E AL Electric Gravel Adventure Bike',
      brand: 'Ribble Cycles',
      retailer: 'Ribble Cycles UK',
      country: 'UK',
      currency: 'GBP',
      ...
      dealBucket: '🔥 Mega Deal',
      dealScore: 32.5,
      motor_power: '250W MAHLE X30 Multi-Surface Drive System',
      battery: '250Wh Integrated Lithium-Ion',
      range_miles: '45 - 70 Miles',
      max_speed: '15.5 mph',
      is_uk_legal: true,
      rrp: 2999,
      sale_price: 2499,
      ...
      url: ribbleBaseTracking + encodeURIComponent('https://www.ribblecycles.co.uk/allgrit-e-al/'),
      badge_text: 'SAVE £500 (17% OFF)',
      first_seen: new Date().toISOString().slice(0, 10),
      is_new: true
    },
    {
      ...
      dealBucket: '🔥 Mega Deal',
      dealScore: 99.0,
      motor_power: '250W-500W Shimano EP8 85Nm',
    ...
    },
    {
      ...
      dealBucket: '🔥 Mega Deal',
      dealScore: 70.6,
      motor_power: '250W-500W Bosch Performance Line CX',
